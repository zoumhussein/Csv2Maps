 ...
 *         <p>
 *         This is an interface which has a method to parse file and generate
 *         List of Map data. <br/>
 *         The list contains maps <br/>
 *         Each map contains keys,values: where key is a column name and value
 *         the value of this column for a specific line of record
 *         </p>
 *         <p>
...
public interface Parser {
	 ...
	 * @throws IOException
	 */
	List<HashMap<String, String>> parseFile(File file)
	 ...
	 * @throws IOException
	 */
	List<HashMap<String, String>> parseFile(File file, char separator)
			throws FileNotFoundException, IOException;
